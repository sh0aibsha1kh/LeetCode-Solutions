class Solution:
    ...
    def string_to_integer(self, s):
        ...
        if len(integer) > 0:
            integer = int(integer)
            return max(-2**31, min(2**31 - 1, sign * integer))
        return 0


if __name__ == "__main__":
    s = Solution()
    print(s.string_to_integer("42"))  # -> 42
    print(s.string_to_integer("   -42"))  # -> -42
    print(s.string_to_integer("4193 with words"))  # -> -4193
    print(s.string_to_integer("words and 987"))  # -> 0
    print(s.string_to_integer("-91283472332"))  # -> -2147483648
    print(s.string_to_integer(""))  # -> 0
    print(s.string_to_integer("-"))  # -> 0
    print(s.string_to_integer(" "))  # -> 0
